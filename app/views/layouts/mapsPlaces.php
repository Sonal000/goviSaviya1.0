<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>/assets/css/mapsPlaces.css" />
    <script type="module" src="<?php echo URLROOT; ?>/assets/js/mapsPlaces.js"></script>
  </head>
  <body>
...
https://developers.google.com/maps/documentation/javascript/examples/places-autocomplete-addressform
  ...
  Not recommended for user-facing forms due to risk of mis-click when aiming for Submit button. -->
    ...
    <!-- 
      ...
      -->
    <script
      src="https://maps.googleapis.com/maps/api/js?key=<?php echo GOOGLEAPI;?>&callback=initAutocomplete&libraries=places&v=weekly"
      defer
    ></script>
  </body>
</html>
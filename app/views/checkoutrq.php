...
<div class="checkout_page section-center">
    ...
    <div class="checkout_title">
        <h4>Request Checkout</h4>

      
    </div>
    <form action="<?php echo URLROOT ?>/orderRequests/placeOrder/<?php  echo $data['request_id'];?>" method="POST" id="placeOrderForm">
...
<div class="sec_title order_title">
    <h4>Your Order</h4>
    <a href="<?php echo URLROOT; ?>/orderRequests/<?php echo $data['request_id'] ?>" class="return_to_cart">return to item</a>
</div>
    ...
    <div class="items_cont">
        <ul>
            ...
            <?php if($data['items']){
                ...
                ?>
            <li class="item" data-price="<?php 
            echo $data['items']->acp_amount; ?>" data-qty="1">
                <div class="item_details">
                    <div class="item_name_cont">
                        ...
                        <div class="item_qty">
                            <p><?php echo $data['items']->req_stock; ?> <span><?php echo $data['items']->unit; ?></span></p>
                        </div>
                    </div>
                ...
                <div class="item_details">
                    ...
                    <div class="delivery_price">
                        <p><span>Rs</span> <?php echo (getDistancefee($data['sellerAddress'],$data['buyerAddress'])); ?></p>
                    </div>
                </div>
            </li>
                        <?php 

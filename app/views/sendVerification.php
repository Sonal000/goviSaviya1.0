...
<div class="login_registration">
  ...
  <div class="form_cont">
   ...
   <form class="login_register_form" id="code_reg_form" method="post" action="<?php echo URLROOT."/register/sendVerification/" ?>">
   ...
   <div class="input_cont">
    ...
    <div class="btn_cont">
     <button  class="signup_btn btn" id="signup_btn">Send</button>
...
<script src="<?php echo URLROOT ?>/assets/js/sendVerify.js"></script>
</body>

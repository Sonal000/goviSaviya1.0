const form = document.getElementById('auc_list_form');
const productNameInput = document.getElementById('product_name');
const unitPriceInput = document.getElementById('unit_price');
const stockInput = document.getElementById('stock');
const expDateInput = document.getElementById('expiration_date');
const startDateInput = document.getElementById('auction_start_date');
...
const listItemBtn = document.getElementById('create_auction_btn');
...
const toggleListingState = (state) => {
  if (state) {
    ...
    listItemBtn.innerHTML = "Creating...";
    loader.classList.toggle('loader_show');
  } else {
    listItemBtn.disabled = false;
    listItemBtn.innerHTML = "Create Auction";
  }
};
...
const inputValidation = () => {
    ...
    if (expDateInput.value.trim() === '') {
      setError(expDateInput, "Expiration date is required.");
    } else {
      setValid(expDateInput);
    }
    ...
    if (startDateInput.value.trim() === '') {
      setError(startDateInput, "Starting date is required.");
    } else {
      setValid(startDateInput);
    }
  
    // Validate end date
    if (endDateInput.value.trim() === '') {
      setError(endDateInput, "Ending date is required.");
    } else {
      setValid(endDateInput);
    }
  };

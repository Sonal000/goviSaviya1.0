...
const sidebarMapping = [
  ...
  { path: "vehicle", ids: ["pickuptrucks_link", "pickuptrucks_link_m"], exclude: [ "containertrucks","cars"] },
  { path: "vehicle/containertrucks", ids: ["containertrucks_link", "containertrucks_link_m"], exclude: [ "ongoing"] },
  { path: "vehicle/cars", ids: ["cars_link", "cars_link_m"], exclude: [ "ongoing"] },
